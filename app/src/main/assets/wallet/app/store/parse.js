...
exports.parseCloudBalance = function (balanceInfo) {
    var m = new Map();
    if (!balanceInfo) {
        for (var i = 0; i < config_1.cloudCurrency.length; i++) {
            m.set(interface_1.CurrencyTypeReverse[config_1.cloudCurrency[i]], 0);
        }
        return m;
    }
    for (var _i = 0; _i < balanceInfo.value.length; _i++) {
        var each = balanceInfo.value[_i];
        m.set(each[0], unitTools_1.smallUnit2LargeUnit(interface_1.CurrencyTypeReverse[each[0]], each[1]));
    }
    m.set(interface_1.CurrencyType.CNYT, 0);
    return m;
};
/**
 * 解析云端账号详情
...
exports.parseRechargeWithdrawalLog = function (coin, val) {
    ...
    if (coin === 'BTC') {
        ...
        for (var _i2 = 0; _i2 < val.length; _i2++) {
            var _record = {
                time: val[_i2][0],
                amount: unitTools_1.wei2Eth(val[_i2][1]),
                hash: val[_i2][3]
            };
 ...
 * 解析发送红包历史记录
 */
exports.parseSendRedEnvLog = function (value, sta) {
 ...
 * 解析红包兑换历史记录
 */
exports.parseConvertLog = function (data, sta) {
...
exports.parseExchangeDetail = function (value) {
    ...
    totalAmount = unitTools_1.smallUnit2LargeUnit(interface_1.CurrencyTypeReverse[data[0][3]], totalAmount);
