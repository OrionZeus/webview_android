(function (_cfg, it, it1) {
				var _$temp = void 0,
				    node = void 0;_$temp = node;{
								var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "diV", "sid": 0 };_node.children = [];_node.attrSize = 1;_node.attrHash = 3979916388;_node.attrs["w-class"] = "withdrawPage";{
												var _$i = 0;
												for (var _iterator = it1.infoList, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
																...
																var i = _$i++;_$temp = _node;{
																				var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 1312370820;_node2.attrs["w-class"] = "items";_$temp = _node2;{
																								var _$parent3 = _$temp;var _node3 = { "attrs": {}, "tagName": "img", "sid": 2 };_node3.children = [];_node3.childHash = 0;_node3.attrSize = 2;_node3.attrHash = 4145449683;_node3.attrs["src"] = "../../../res/image/cloud_withdraw_icon.png";_node3.attrs["w-class"] = "itemIcon";_$parent3.children.push(_node3);
																				}_$temp = _node2;{
																								var _$parent4 = _$temp;var _node4 = { "attrs": {}, "tagName": "div", "sid": 3 };_node4.children = [];_node4.attrSize = 1;_node4.attrHash = 1219942747;_node4.attrs["w-class"] = "info";_$temp = _node4;{
																												var _$parent5 = _$temp;var _node5 = { "attrs": {}, "tagName": "p", "sid": 4 };_node5.children = [];_node5.childHash = 2443864228;_node5.attrSize = 1;_node5.attrHash = 3148989585;_node5.attrs["w-class"] = "behavior";_$temp = _node5;{
																																var _$parent6 = _$temp;var _node6 = _installText("提币", 3823202706);;
																								...
																								var _$parent9 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 6 };_node8.children = [];_node8.attrSize = 1;_node8.attrHash = 1141695757;_node8.attrs["w-class"] = "amount";_$temp = _node8;{
																												...
																												var _$parent12 = _$temp;var _node10 = { "attrs": {}, "tagName": "p", "sid": 8 };_node10.children = [];_node10.attrSize = 2;_node10.attrHash = 1097375837;_node10.attrs["w-class"] = "statas";{
																																var attrvalue = "";attrvalue += "color: ";attrvalue += v.status === 0 ? '#E1953C' : '';attrvalue += ";";_node10.attrs["style"] = attrvalue;
