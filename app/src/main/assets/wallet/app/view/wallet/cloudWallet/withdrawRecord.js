...
var WithdrawRecord = function (_widget_1$Widget) {
    ...
    _createClass(WithdrawRecord, [{
        ...
        key: "init",
        value: function init() {
            var withdrawLogs = store_1.getBorn('withdrawLogs').get(interface_1.CurrencyType[this.props.currencyName]) || { list: [], start: 0, canLoadMore: false };
            this.state = {
        ...
        value: function parseRecordList(list) {
            ...
            list.forEach(function (item) {
                ...
                item.behavior = _this2.state.cfgData.withdraw;
