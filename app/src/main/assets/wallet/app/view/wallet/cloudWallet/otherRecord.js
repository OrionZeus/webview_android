...
var OtherRecord = function (_widget_1$Widget) {
    ...
    _createClass(OtherRecord, [{
        ...
        value: function init() {
            ...
            var accountDetail = store_1.getBorn('accountDetail').get(interface_1.CurrencyType[this.props.currencyName]) || { list: [], start: 0, canLoadMore: false };
            this.state = {
        ...
        value: function loadMore() {
            pull_1.getAccountDetail(this.props.currencyName, 1, this.state.nextStart);
        }
    }, {
        key: "getMoreList",
