                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[0] });
                                return _context.abrupt("return");
                            ...
                            case 5:
                                ...
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[1] });
                                return _context.abrupt("return");
                            ...
                            case 11:
                                ...
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[3] });
                                return _context.abrupt("return");
                            ...
                            case 19:
                                ...
                                store_1.updateStore('flag', { created: true, mnemonic: mnemonic, fragments: fragments });
...
// 登录状态成功
store_1.register('flag', function (flag) {
    if (flag.promptBackup) {
        root_1.popNew('app-components-modalBox-modalBox', tools_1.getStaticLanguage().createSuccess, function () {
            root_1.popNew('app-view-wallet-backup-index', { mnemonic: flag.mnemonic, fragments: flag.fragments });
        });
    }
});
})