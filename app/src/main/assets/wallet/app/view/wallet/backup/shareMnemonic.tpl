	...
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 3437572703;_node.attrs["class"] = "new-page";_node.attrs["w-class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_$temp = _node;{
			...
			var _$parent4 = _$temp;var _node4 = { "attrs": {}, "tagName": "div", "sid": 2 };_node4.children = [];_node4.attrSize = 1;_node4.attrHash = 4252679546;_node4.attrs["w-class"] = "body";_$temp = _node4;{
				var _$parent5 = _$temp;var _node5 = { "attrs": {}, "tagName": "app-view-wallet-components-tipsCard", "sid": 3 };_node5.hasChild = false;_node5.child = null;_node5.childHash = 146273389;_node5.attrHash = 0;_$temp = _node5;{
					var _$parent6 = _$temp;var _node6 = {}; //jpair pre

					{
						var _jvalue = "";
						_jvalue = "color:#ef3838;";
						//jpair suf

						_node6["contentStyle"] = _jvalue;
					}
					//jpair pre

					{
						...
						_node6["title"] = _jvalue2;
					}
					//jpair pre

					{
						var _jvalue3 = "";
						_jvalue3 = "助记词是您找回账号的唯一凭证，如果丢失，KuPay将无法恢复您的账号和资产。请务必妥善保管您的助记词。";
						//jpair suf

						_node6["content"] = _jvalue3;
					}
						...
						var i = _$i++;_$temp = _node7;{
							var _$parent8 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 5 };_node8.children = [];_node8.attrSize = 2;_node8.attrHash = 1734586514;_node8.attrs["w-class"] = "item";{
								...
								var _$parent10 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 7 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 830343746;_node10.attrs["w-class"] = "share-box";_$temp = _node10;{
									var _$parent11 = _$temp;var _node11 = { "attrs": {}, "tagName": "div", "sid": 8 };_node11.children = [];_node11.childHash = 2639799485;_node11.attrSize = 1;_node11.attrHash = 2098153414;_node11.attrs["w-class"] = "share-title";_$temp = _node11;{
										var _$parent12 = _$temp;var _node12 = _installText("分享给好友", 807898982);;
										_$parent12.children.push(_node12);
									}_$parent11.children.push(_node11);
								}_$temp = _node10;{
									var _$parent13 = _$temp;var _node13 = { "attrs": {}, "tagName": "div", "sid": 9 };_node13.children = [];_node13.attrSize = 1;_node13.attrHash = 2945576030;_node13.attrs["w-class"] = "share-fragment";_$temp = _node13;{
										var _$parent14 = _$temp;_addText(it.fragments[i], _$parent14);
									}_chFunc(_node13);_$parent13.children.push(_node13);
								}_chFunc(_node10);_$parent10.children.push(_node10);
							}_$temp = _node8;{
								var _$parent15 = _$temp;var _node14 = { "attrs": {}, "tagName": "div", "sid": 10 };_node14.children = [];_node14.attrSize = 1;_node14.attrHash = 197278587;_node14.attrs["w-class"] = "choose-box";if (v) {
									_$temp = _node14;{
										var _$parent16 = _$temp;var _node15 = { "attrs": {}, "tagName": "img", "sid": 11 };_node15.children = [];_node15.childHash = 0;_node15.attrSize = 2;_node15.attrHash = 2700988036;_node15.attrs["src"] = "../../../res/image/icon_right2.png";_node15.attrs["w-class"] = "choosed";_$parent16.children.push(_node15);
									}
								} else {
									_$temp = _node14;{
										var _$parent17 = _$temp;var _node16 = { "attrs": {}, "tagName": "div", "sid": 12 };_node16.children = [];_node16.childHash = 2946814719;_node16.attrSize = 1;_node16.attrHash = 1278218974;_node16.attrs["w-class"] = "choose-inner";_$parent17.children.push(_node16);
									}
