_$define("app/view/wallet/assets/search_asset", function (require, exports, module){
"use strict";
...
var AddAsset = function (_widget_1$Widget) {
    ...
    _createClass(AddAsset, [{
        ...
        value: function onInputChange(e) {
            var list = [];
            if (e.value) {
                list = this.props.list.filter(function (v) {
                    return v.name.toLowerCase().indexOf(e.value.toLowerCase()) >= 0;
                });
            }
