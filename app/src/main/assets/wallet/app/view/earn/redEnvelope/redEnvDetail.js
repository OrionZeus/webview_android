                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                url = '';
                                title = '';
                                lanSet = store_1.find('languageSet');
                                ...
                                url = pull_1.sharePerUrl + "?type=" + interface_1.RedEnvelopeType.Normal + "&rid=" + this.props.rid + "&lm=" + window.encodeURIComponent(this.state.message) + "&lan=" + lan;
                            ...
                            case 9:
                                ...
                                // tslint:disable-next-line:max-line-length
                                url = pull_1.sharePerUrl + "?type=" + interface_1.RedEnvelopeType.Random + "&rid=" + this.props.rid + "&lm=" + window.encodeURIComponent(this.state.message) + "&lan=" + lan;
                            ...
                            case 20:
                                url = pull_1.sharePerUrl + "?cid=" + inviteCodeInfo.cid + "&type=" + interface_1.RedEnvelopeType.Invite + "&lan=" + lan;
