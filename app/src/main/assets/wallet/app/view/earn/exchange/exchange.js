                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                root_1.popNew('app-components1-message-message', { itype: 'error', content: this.state.cfgData.errorList[0], center: true });
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 25:
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.errorList[1] });
