(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 4;_node.attrHash = 2090337910;_node.attrs["class"] = "new-page";_node.attrs["ev-back-click"] = "backPrePage";_node.attrs["w-class"] = "new-page";_node.attrs["ev-refresh-click"] = "refreshPage";if (!it1.isScroll) {
			_$temp = _node;{
			...
			_$temp = _node;{
				var _$parent4 = _$temp;var _node4 = { "attrs": {}, "tagName": "app-components1-topBar-topBar", "sid": 2 };_node4.hasChild = false;_node4.child = null;_node4.attrHash = 0;_$temp = _node4;{
					...
					{
						var _jvalue2 = "";
						_jvalue2 = "../../res/image1/refresh_blue.png";
						//jpair suf

						_node5["refreshImg"] = _jvalue2;
					}
					_addJson(_node5, _$parent5);
				}_chFunc(_node4);_$parent4.children.push(_node4);
			}
		}_$temp = _node;{
			var _$parent6 = _$temp;var _node6 = { "attrs": {}, "tagName": "div", "sid": 3 };_node6.children = [];_node6.attrSize = 3;_node6.attrHash = 1213754612;_node6.attrs["w-class"] = "content";_node6.attrs["on-scroll"] = "getMoreList";_node6.attrs["id"] = "exchangeHistoryContent";_$temp = _node6;{
				var _$parent7 = _$temp;var _node7 = { "attrs": {}, "tagName": "div", "sid": 4 };_node7.children = [];_node7.attrSize = 2;_node7.attrHash = 262038940;_node7.attrs["id"] = "exchangeHistoryRecords";_node7.attrs["w-class"] = "records";_$temp = _node7;{
					var _$parent8 = _$temp;var _node8 = { "attrs": {}, "tagName": "img", "sid": 5 };_node8.children = [];_node8.childHash = 0;_node8.attrSize = 2;_node8.attrHash = 1436780041;_node8.attrs["src"] = "../../../res/image/redEnvtop1.png";_node8.attrs["w-class"] = "topBackimg";_$parent8.children.push(_node8);
				}_$temp = _node7;{
					var _$parent9 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 6 };_node9.children = [];_node9.attrSize = 1;_node9.attrHash = 2188685783;_node9.attrs["w-class"] = "topBack";_$temp = _node9;{
						...
						var _$parent13 = _$temp;var _node12 = { "attrs": {}, "tagName": "div", "sid": 9 };_node12.children = [];_node12.attrSize = 1;_node12.attrHash = 3864739911;_node12.attrs["style"] = "margin-bottom: 90px;";_$temp = _node12;{
							var _$parent14 = _$temp;var _node13 = { "attrs": {}, "tagName": "span", "sid": 10 };_node13.children = [];_node13.attrSize = 1;_node13.attrHash = 395455977;_node13.attrs["style"] = "font-size: 64px;";_$temp = _node13;{
								var _$parent15 = _$temp;_addText(it1.convertNumberShow, _$parent15);
					...
					var _$parent17 = _$temp;var _node14 = { "attrs": {}, "tagName": "div", "sid": 11 };_node14.children = [];_node14.attrSize = 1;_node14.attrHash = 832204064;_node14.attrs["w-class"] = "bottom";if (it1.recordListShow.length == 0) {
						_$temp = _node14;{
							var _$parent18 = _$temp;var _node15 = { "attrs": {}, "tagName": "div", "sid": 12 };_node15.children = [];_node15.attrSize = 1;_node15.attrHash = 3583682907;_node15.attrs["style"] = "text-align: center;";_$temp = _node15;{
								var _$parent19 = _$temp;var _node16 = { "attrs": {}, "tagName": "img", "sid": 13 };_node16.children = [];_node16.childHash = 0;_node16.attrSize = 2;_node16.attrHash = 3195622359;_node16.attrs["src"] = "../../../res/image/exchangeEmpty.png";_node16.attrs["style"] = "width: 200px;height: 200px;margin-top: 210px;";_$parent19.children.push(_node16);
							}_$temp = _node15;{
						...
						_$temp = _node14;{
							var _$parent27 = _$temp;var _node22 = { "attrs": {}, "tagName": "div", "sid": 18 };_node22.children = [];_node22.attrSize = 2;_node22.attrHash = 2710372230;_node22.attrs["w-class"] = "endMess";_node22.attrs["id"] = "more";_$temp = _node22;{
								var _$parent28 = _$temp;_addText(it1.cfgData.tips[5], _$parent28);
							}_$temp = _node22;{
