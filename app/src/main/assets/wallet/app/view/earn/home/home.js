...
var PlayHome = function (_widget_1$Widget) {
    ...
    _createClass(PlayHome, [{
        ...
        value: function scrollPage() {
            var scrollTop = document.getElementById('contain').scrollTop;
        ...
        value: function initDate() {
            ...
            if (mining) {
                ...
                this.state.mines = tools_1.formatBalance(mining.thisNum);
                this.state.mineLast = tools_1.formatBalance(mining.totalNum - mining.holdNum);
            } else {
