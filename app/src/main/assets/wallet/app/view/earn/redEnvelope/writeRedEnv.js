                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 10:
                                ...
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[4] });
                                return _context2.abrupt("return");
                            ...
                            case 13:
                                ...
                                root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[5] });
                                return _context2.abrupt("return");
                                                ...
                                                switch (_context.prev = _context.next) {
                                                    ...
                                                    case 4:
                                                        ...
                                                        if (fg) {
                                                            ...
                                                            root_1.popNew('app-components1-message-message', { content: this.state.cfgData.tips[6] });
                                                        }
