				...
				var _$temp = void 0,
				    node = void 0;_$temp = node;{
								var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 1;_node.attrHash = 222693721;_node.attrs["w-class"] = "list-container";{
																												...
																												var _$parent10 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 7 };_node8.children = [];_node8.attrSize = 1;_node8.attrHash = 1923323011;_node8.attrs["w-class"] = "bottom-container";_$temp = _node8;{
																																...
																																var _$parent13 = _$temp;var _node10 = { "attrs": {}, "tagName": "div", "sid": 9 };_node10.children = [];_node10.attrSize = 1;_node10.attrHash = 2888409400;_node10.attrs["w-class"] = "balance-container";_$temp = _node10;{
																																				var _$parent14 = _$temp;var _node11 = { "attrs": {}, "tagName": "div", "sid": 10 };_node11.children = [];_node11.attrSize = 1;_node11.attrHash = 1532757002;_node11.attrs["w-class"] = "balance-value";_$temp = _node11;{
																																								var _$parent15 = _$temp;_addText(it.currencyUnitSymbol, _$parent15);
																																				}_$temp = _node11;{
																																								var _$parent16 = _$temp;_addText(v.balanceValue, _$parent16);
																																				}_chFunc(_node11);_$parent14.children.push(_node11);
																																}if (it.redUp) {
																																				_$temp = _node10;{
																																								var _$parent17 = _$temp;var _node12 = { "attrs": {}, "tagName": "div", "sid": 11 };_node12.children = [];_node12.attrSize = 1;_node12.attrHash = 988550338;{
																																												var _attrvalue2 = "";_attrvalue2 += "gain ";_attrvalue2 += v.gain >= 0 ? 'gain-up' : 'gain-down';_attrvalue2 += "";_node12.attrs["w-class"] = _attrvalue2;
																																												...
																																												var _$parent20 = _$temp;var _node13 = _installText("%", 4257547020);;
																																												_$parent20.children.push(_node13);
																																								}_chFunc(_node12);_$parent17.children.push(_node12);
																																				}
																																} else {
																																				_$temp = _node10;{
																																								var _$parent21 = _$temp;var _node14 = { "attrs": {}, "tagName": "div", "sid": 12 };_node14.children = [];_node14.attrSize = 1;_node14.attrHash = 988550338;{
																																												var _attrvalue3 = "";_attrvalue3 += "gain ";_attrvalue3 += v.gain >= 0 ? 'gain-down' : 'gain-up';_attrvalue3 += "";_node14.attrs["w-class"] = _attrvalue3;
												...
												var _$parent25 = _$temp;var _node16 = { "attrs": {}, "tagName": "div", "sid": 13 };_node16.children = [];_node16.childHash = 2946814719;_node16.attrSize = 1;_node16.attrHash = 2767495787;_node16.attrs["w-class"] = "space";_$parent25.children.push(_node16);
