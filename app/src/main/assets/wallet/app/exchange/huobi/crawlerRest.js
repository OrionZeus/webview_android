_$define("app/exchange/huobi/crawlerRest", function (require, exports, module){
"use strict";
...
var BASE_URL = 'https://api.huobipro.com';
var orderbook = {};
/**
 * 获取订阅数据
 */
...
var getDepth = function getDepth(coin, currency) {
    return new Promise(function (resolve) {
        var url = BASE_URL + "/market/depth?symbol=" + coin + currency + "&type=step0";
