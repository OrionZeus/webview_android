...
var EthWallet = function () {
    ...
    _createClass(EthWallet, [{
        ...
        value: function tokenOperations(method, tokenName, toAddr, amount) {
            var tokenAddress = tokens_1.ERC20Tokens[tokenName];
...
var initWeb3 = function initWeb3() {
    if (!web3) {
        web3 = new web3_min_1.Web3(new web3_min_1.Web3.providers.HttpProvider(config_1.config.dev_mode === 'dev' ? config_1.config.dev.EthApiBaseUrl : config_1.config.prod.EthApiBaseUrl));
    }
};
})