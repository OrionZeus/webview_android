...
exports.fetchUSD2CNYRate = function () {
    var url3Prefix = 'http://api.k780.com/?app=finance.rate&scur=USD&tcur=CNY';
    var url = pull_1.thirdUrlPre + "url=" + encodeURIComponent(url3Prefix) + "&type=rite";
...
exports.fetchCurrency2USDTRate = function (currencyName) {
    ...
    var symbol = currencyName.toLowerCase() + "usdt";
    var url3Prefix = "https://api.huobipro.com/market/history/kline?symbol=" + symbol;
    var url = pull_1.thirdUrlPre + "url=" + encodeURIComponent(url3Prefix) + "&type=kline";
    return fetch(url).then(function (res) {
        return res.json();
    });
};
