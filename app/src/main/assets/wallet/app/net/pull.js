...
exports.thirdUrlPre = "http://47.75.254.166:8080/data/proxy?";
// 分享链接前缀
...
// 分享下载链接
exports.shareDownload = "http://" + exports.conIp + ":" + exports.conPort + "/wallet/phoneRedEnvelope/download.html";
// 上传图片url
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 14:
                        ...
                        if (res.result === 1) {
                            store_1.updateStore('loginState', interface_1.LoginState.logined);
                            root_1.popNew('app-components1-message-message', { content: tools_1.getStaticLanguage().userInfo.loginSuccess });
                        } else {
                            store_1.updateStore('loginState', interface_1.LoginState.logerror);
                        }
...
exports.getRandom = function (cmd) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
        var client, param, msg, resp, _flag, hash, flag;
            ...
            while (1) {
                switch (_context9.prev = _context9.next) {
                    ...
                    case 2:
                        client = "android 20";
                        param = {
                            account: store_1.find('conUser').slice(2),
                            pk: "04" + store_1.find('conUserPublicKey'),
                    ...
                    case 22:
                        ...
                        console.log('getRandom----------', _context9.t0);
                        if (_context9.t0.type === 1014) {
                            root_1.popNew('app-components1-modalBoxCheckBox-modalBoxCheckBox', { title: "检测到在其它设备有登录", content: "清除其它设备账户信息" }, function (deleteAccount) {
                                if (deleteAccount) {
                                    exports.getRandom(constants_1.CMD.FORCELOGOUTDEL);
                                } else {
                                    exports.getRandom(constants_1.CMD.FORCELOGOUT);
                                }
                                var flag = store_1.find('flag');
                                // 第一次创建检查是否有登录后弹框提示备份
                                if (flag.created) {
                                    store_1.updateStore('flag', { promptBackup: true, mnemonic: flag.mnemonic, fragments: flag.fragments });
                                }
                            }, function () {
                                exports.getRandom(constants_1.CMD.FORCELOGOUT);
                                var flag = store_1.find('flag');
...
exports.getCloudBalance = function () {
    if (!store_1.find('conRandom')) return Promise.reject();
    var list = [];
    list.push(interface_1.CurrencyType.KT);
    ...
    return exports.requestAsync(msg).then(function (balanceInfo) {
        ...
        store_1.updateStore('cloudBalance', parse_1.parseCloudBalance(null));
    });
};
/**
 * 获取指定类型的货币余额
...
exports.getUserInfoFromServer = function (uids) {
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee30() {
        var msg, res, userInfoStr, userInfo;
...
exports.getAccountDetail = function (coin, filter) {
    ...
    return __awaiter(undefined, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee33() {
        var msg, res, nextStart, detail, canLoadMore, accountDetailMap, accountDetail, _accountDetail$list, totalLogMap, totalLogs, _totalLogs$list;
                ...
                switch (_context33.prev = _context33.next) {
                    ...
                    case 5:
                        ...
                        if (filter === 1) {
                            ...
                            totalLogMap = store_1.getBorn('totalLogs');
                            totalLogs = totalLogMap.get(interface_1.CurrencyType[coin]) || { list: [] };

                            if (!start) {
                                totalLogs.list = detail;
                            } else {
                                (_totalLogs$list = totalLogs.list).push.apply(_totalLogs$list, _toConsumableArray(detail));
                            }
                            totalLogs.start = nextStart;
                            totalLogs.canLoadMore = canLoadMore;
                            totalLogMap.set(interface_1.CurrencyType[coin], totalLogs);
                            store_1.updateStore('totalLogs', totalLogMap);
                        }
                        _context33.next = 16;
                        break;
            ...
            while (1) {
                switch (_context36.prev = _context36.next) {
                    ...
                    case 7:
                        ...
                        toolMessages_1.showError(_context36.t0 && (_context36.t0.result || _context36.t0.type));
            ...
            while (1) {
                switch (_context37.prev = _context37.next) {
                    ...
                    case 7:
                        ...
                        toolMessages_1.showError(_context37.t0 && (_context37.t0.result || _context37.t0.type));
