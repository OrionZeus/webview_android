            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 6:
                        ...
                        if (exports.getFirstEthAddr()) {
                            hashMap = store_1.getBorn('hashMap');

                            hashMap.set(exports.getFirstEthAddr(), hash);
...
exports.fetchCloudTotalAssets = function () {
    ...
    for (var _iterator = cloudBalance, _isArray = Array.isArray(_iterator), _i2 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        ...
        totalAssets += exports.fetchBalanceValueOfCoin(interface_1.CurrencyTypeReverse[k], v);
    }
    return totalAssets;
};
/**
...
exports.fetchBalanceValueOfCoin = function (currencyName, balance) {
    var balanceValue = 0;
    var USD2CNYRate = store_1.find('USD2CNYRate');
    ...
    if (currencyUnit === interface_1.CurrencyUnit.CNY) {
        balanceValue = balance * currency2USDT.close * USD2CNYRate;
    } else if (currencyUnit === interface_1.CurrencyUnit.USD) {
...
exports.fetchCloudWalletAssetList = function () {
    var assetList = [];
    var ktBalance = store_1.getBorn('cloudBalance').get(interface_1.CurrencyType.KT) || 0;
    var ktItem = {
        currencyName: 'KT',
        description: 'KuPlay Token',
        balance: exports.formatBalance(ktBalance),
        balanceValue: exports.formatBalanceValue(exports.fetchBalanceValueOfCoin('KT', ktBalance)),
        gain: exports.formatBalanceValue(0)
    };
...
exports.fetchWalletAssetListAdded = function () {
    ...
    for (var _k2 in config_1.ERC20Tokens) {
        ...
        if (config_1.ERC20Tokens.hasOwnProperty(_k2)) {
            ...
            if (constants_1.defalutShowCurrencys.indexOf(_k2) >= 0) {
...
exports.fetchCoinGain = function (currencyName) {
    var currency2USDT = store_1.getBorn('currency2USDTMap').get(currencyName);
...
exports.logoutAccount = function () {
    store_1.updateStore('flag', { logoutAccountSave: true });
    store_1.logoutInit();
    pull_1.openAndGetRandom();
};
/**
 * 登录成功
 */
exports.loginSuccess = function (wallet) {
    store_1.updateStore('curWallet', wallet);
    con_mgr_1.setConState(con_mgr_1.ConState.init);
    store_1.loginInit();
    pull_1.openAndGetRandom();
};
/**
...
exports.getLocalVersion = function () {
    ...
    var version = versionStr.slice(0, versionStr.length - 7);
    return version;
};
// 获取远端版本号
...
exports.fetchMinerFeeList = function (currencyName) {
    ...
    for (var i = 0; i < toa.length; i++) {
        var minerFee = 0;
        if (cn === 'ETH') {
            var gasLimit = store_1.getBorn('gasLimitMap').get(currencyName) || constants_1.defaultGasLimit;
