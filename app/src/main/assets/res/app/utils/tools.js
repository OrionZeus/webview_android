...
exports.getCurrentWallet = function (wallets) {
 ...
 */
exports.getCurrentWalletIndex = function (wallets) {
    var index = -1;
    if (!(wallets && wallets.curWalletId && wallets.curWalletId.length > 0)) {
        return -1;
    }
...
exports.getCurrentAddrInfo = function (currencyName) {
    var wallets = exports.getLocalStorage('wallets');
    var addrs = exports.getLocalStorage('addrs');
    var wallet = exports.getCurrentWallet(wallets);
...
exports.getAddrById = function (addrId, currencyName) {
    var list = exports.getLocalStorage('addrs') || [];
...
exports.resetAddrById = function (addrId, currencyName, data, notified) {
    ...
    exports.setLocalStorage('addrs', list, notified);
};
/**
 * 获取钱包下的所有地址
...
exports.effectiveCurrency = function (perNum, currencyName, conversionType, isMinUnit) {
    ...
    var num = void 0;
    if (currencyName === 'ETH') {
        num = isMinUnit ? exports.wei2Eth(!util_1.isNumber(perNum) ? perNum.toNumber() : perNum) : perNum;
...
exports.addNewAddr = function (currencyName, address, addrName) {
    ...
    exports.setLocalStorage('addrs', list, false);
    exports.setLocalStorage('wallets', wallets, true);
    return newAddrInfo;
};
// 函数防抖
...
exports.fetchBalanceOfCurrency = function (addrs, currencyName) {
    var localAddrs = exports.getLocalStorage('addrs');
    var balance = 0;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return exports.calcHashValuePromise(passwd, dataCenter_1.dataCenter.salt, wallet.walletId);
...
exports.lockScreenVerify = function (psw) {
    var hash256 = exports.sha256(psw + constants_1.lockScreenSalt);
    var localHash256 = exports.getLocalStorage('lockScreenPsw');
    return hash256 === localHash256;
};
// 锁屏密码hash算法
exports.lockScreenHash = function (psw) {
    return exports.sha256(psw + constants_1.lockScreenSalt);
};
// 复制到剪切板
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        hash = dataCenter_1.dataCenter.getHash(walletId);
...
exports.currencyExchangeAvailable = function () {
    var shapeshiftCoins = dataCenter_1.dataCenter.shapeShiftCoins;
    var currencyArr = [];
