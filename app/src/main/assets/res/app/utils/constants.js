...
// todo 测试网络与正式网络切换
// btc网络
exports.btcNetwork = 'testnet';
// 语言
exports.lang = 'english';
// 默认货币汇率测试网络
var defaultExchangeRateJsonTest = {
...
// 默认货币汇率主网络
var defaultExchangeRateJsonMain = {
    ETH: { CNY: 3337.01, USD: 517.42 },
    BTC: { CNY: 42868.55, USD: 6598.71 },
    KT: { CNY: 0.03, USD: 0.19 },
...
// 默认货币汇率
exports.defaultExchangeRateJson = config_1.config.currentNetIsTest ? defaultExchangeRateJsonTest : defaultExchangeRateJsonMain;
// eth代币transfer交易编码前缀
exports.ethTokenTransferCode = '0xa9059cbb';
// 导航页广告
exports.guidePages = [{ imgUrl: 'banner1.png', text: '介绍我们的特色或者是更新内容，介绍我们的特色或者是更新内容，介绍我们的特色或者是更新内容' }, { imgUrl: 'banner2.png', text: '以太坊，Ethereum是一个分布式的计算机，有许多的节点，其中的每一个节点，都会执行字节码（其实就是智能合约），然后把结果存在区块链上。' }, { imgUrl: 'banner3.png', text: '智能合约与平时的代码其实没有什么区别，只是运行于一个以太坊这样的分布式平台上而已。' }];
// 锁屏密码盐值
