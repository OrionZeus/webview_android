...
exports.walletNameAvailable = function (walletName) {
    return tools_1.getStrLen(walletName.trim()) >= 1 && tools_1.getStrLen(walletName.trim()) <= 24;
};
/**
 * 钱包密码是否合乎规则
...
exports.walletCountAvailable = function () {
    ...
    return wallets ? wallets.walletList.length < constants_1.walletNumLimit : true;
};
/**
 * 获取密码强度对象
 * @param walletPsw wallet password
...
exports.getAvatarRandom = function () {
    ...
    var avatarsSrc = ['img_avatar1.jpg', 'img_avatar2.jpg', 'img_avatar3.jpg', 'img_avatar4.jpg', 'img_avatar5.jpg', 'img_avatar6.jpg', 'img_avatar7.jpg', 'img_avatar8.jpg', 'img_avatar9.jpg', 'img_avatar10.jpg'];
    var wallets = tools_1.getLocalStorage('wallets');
    var avatarUsed = [];
    if (wallets) {
        wallets.walletList.forEach(function (item) {
