    ...
    _createClass(GlobalWallet, [{
        ...
        value: function passwordChange(oldPsw, newPsw, walletId) {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var oldHash, newHash, oldVault;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return tools_1.calcHashValuePromise(oldPsw, dataCenter_1.dataCenter.salt, walletId);

                            case 2:
                                oldHash = _context.sent;
                                _context.next = 5;
                                return tools_1.calcHashValuePromise(newPsw, dataCenter_1.dataCenter.salt, null);
        ...
        key: "fromMnemonic",
        value: function fromMnemonic(mnemonic, passwd, passphrase) {
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return tools_1.calcHashValuePromise(passwd, dataCenter_1.dataCenter.salt, null);
        ...
        key: "generate",
        value: function generate(passwd, walletName, passphrase, vault) {
