...
var web3 = void 0;
var ETHSCAN_ROPSTEN_API_URL = config_1.config.currentNetIsTest ? config_1.config.eth.TEST_ETHSCAN_ROPSTEN_API_URL : config_1.config.eth.MAIN_ETHSCAN_ROPSTEN_API_URL;
// tslint:disable-next-line:max-line-length
var ETHSCAN_ROPSTEN_TOKEN_TRANSFER_EVENT = config_1.config.currentNetIsTest ? config_1.config.eth.TEST_ETHSCAN_ROPSTEN_TOKEN_TRANSFER_EVENT : config_1.config.eth.MAIN_ETHSCAN_ROPSTEN_TOKEN_TRANSFER_EVENT;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return fetch(config_1.config.eth.ETH_CMC_URL);
...
var initWeb3 = function initWeb3() {
    if (!web3) {
        web3 = new web3_min_1.Web3(new web3_min_1.Web3.providers.HttpProvider(config_1.config.currentNetIsTest ? config_1.config.eth.testWeb3 : config_1.config.eth.mainWeb3));
    }
};
})