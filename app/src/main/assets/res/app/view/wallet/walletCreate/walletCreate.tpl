(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 846922391;_node.attrs["class"] = "ga-new-page";_node.attrs["ev-back-click"] = "backPrePage";_node.attrs["w-class"] = "ga-new-page";_$temp = _node;{
			...
			var _$parent4 = _$temp;var _node4 = { "attrs": {}, "tagName": "div", "sid": 2 };_node4.children = [];_node4.childHash = 2905222256;_node4.attrSize = 1;_node4.attrHash = 4148826170;_node4.attrs["w-class"] = "ga-notice-text";_$temp = _node4;{
			...
			var _$parent6 = _$temp;var _node6 = { "attrs": {}, "tagName": "div", "sid": 3 };_node6.children = [];_node6.attrSize = 1;_node6.attrHash = 541041940;_node6.attrs["w-class"] = "ga-registered-container";_$temp = _node6;{
				...
				var _$parent13 = _$temp;var _node13 = { "attrs": {}, "tagName": "div", "sid": 8 };_node13.children = [];_node13.attrSize = 2;_node13.attrHash = 2598722585;_node13.attrs["w-class"] = "ga-registered-item";_node13.attrs["ev-input-change"] = "walletPswChange";_$temp = _node13;{
				...
				var _$parent24 = _$temp;var _node23 = { "attrs": {}, "tagName": "div", "sid": 15 };_node23.children = [];_node23.attrSize = 2;_node23.attrHash = 415075680;{
					var _attrvalue = "";_attrvalue += "ga-psw-tip-hidden  ";_attrvalue += it1.walletPsw.length > 0 ? 'ga-psw-tip-show' : '';_attrvalue += "";_node23.attrs["w-class"] = _attrvalue;
				...
				var _$parent32 = _$temp;var _node31 = { "attrs": {}, "tagName": "div", "sid": 20 };_node31.children = [];_node31.childHash = 710771667;_node31.attrSize = 2;_node31.attrHash = 3609946228;_node31.attrs["w-class"] = "ga-registered-item";_node31.attrs["ev-input-change"] = "walletPswTipsChange";_$temp = _node31;{
					var _$parent33 = _$temp;var _node32 = { "attrs": {}, "tagName": "div", "sid": 21 };_node32.children = [];_node32.childHash = 1093794078;_node32.attrSize = 1;_node32.attrHash = 1495868631;_node32.attrs["w-class"] = "ga-registered-item-label";_$temp = _node32;{
				...
				var _$parent38 = _$temp;var _node37 = { "attrs": {}, "tagName": "div", "sid": 24 };_node37.children = [];_node37.childHash = 2119459271;_node37.attrSize = 2;_node37.attrHash = 2984237632;_node37.attrs["w-class"] = "ga-registered-protocol";_node37.attrs["ev-checkbox-click"] = "checkBoxClick";_$temp = _node37;{
				...
				var _$parent43 = _$temp;var _node42 = { "attrs": {}, "tagName": "div", "sid": 27 };_node42.children = [];_node42.attrSize = 3;_node42.attrHash = 2064656703;_node42.attrs["w-class"] = "ga-wallet-create-btn";_node42.attrs["on-tap"] = "createWalletClick";{
					var _attrvalue2 = "";_attrvalue2 += "backgroundColor:";_attrvalue2 += it1.userProtocolReaded ? '#1A70DD' : 'white';_attrvalue2 += ";color:";_attrvalue2 += it1.userProtocolReaded ? 'rgba(255,255,255,0.87)' : '#1A70DD';_attrvalue2 += "";_node42.attrs["style"] = _attrvalue2;
				}_node42.attrHash = _hash.nextHash(_node42.attrHash, _calTextHash(_node42.attrs["style"]));_$temp = _node42;{
					var _$parent44 = _$temp;var _node43 = _installText("创建钱包", 3372004917);;
