(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 1839940969;_node.attrs["class"] = "ga-new-page";_node.attrs["ev-back-click"] = "backPrePage";_node.attrs["style"] = "background-color: #fff;";_$temp = _node;{
			...
			var _$parent8 = _$temp;var _node8 = { "attrs": {}, "tagName": "div", "sid": 5 };_node8.children = [];_node8.childHash = 622647716;_node8.attrSize = 1;_node8.attrHash = 2002705810;_node8.attrs["w-class"] = "shortmess";_$temp = _node8;{
				var _$parent9 = _$temp;var _node9 = _installText("fairblock是一款功能全面、简单易用的钱包应用。", 4244789946);;
