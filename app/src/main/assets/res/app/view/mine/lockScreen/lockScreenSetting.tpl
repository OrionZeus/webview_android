(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 3;_node.attrHash = 1957018759;_node.attrs["class"] = "ga-new-page";_node.attrs["w-class"] = "ga-new-page";_node.attrs["ev-back-click"] = "backPrePage";_$temp = _node;{
			...
			_$temp = _node;{
				var _$parent14 = _$temp;var _node14 = { "attrs": {}, "tagName": "div", "sid": 9 };_node14.children = [];_node14.attrSize = 2;_node14.attrHash = 3796788450;_node14.attrs["ev-completed-click"] = "completedInput";_node14.attrs["ev-forgetPassword-click"] = "forgetPasswordClick";_$temp = _node14;{
					var _$parent15 = _$temp;var _node15 = { "attrs": {}, "tagName": "app-components-passwordScreen-passwordScreen", "sid": 10 };_node15.hasChild = false;_node15.child = null;_node15.attrHash = 0;_$temp = _node15;{
						var _$parent16 = _$temp;var _node16 = {}; //jpair pre

						_node16["title"] = it1.lockScreenTitle;
						//jpair suf
						//jpair pre

						_node16["forgetPsw"] = true;
						//jpair suf
