(function (_cfg, it, it1) {
  var _$temp = void 0,
    ...
    var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 2551807503;{
      var attrvalue = "";attrvalue += "main main_";attrvalue += it.itype;attrvalue += " ";attrvalue += it.center ? 'main_center' : '';attrvalue += "";_node.attrs["w-class"] = attrvalue;
      ...
      var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "p", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 370807749;{
        var _attrvalue2 = "";_attrvalue2 += "text text_";_attrvalue2 += it.itype;_attrvalue2 += "";_node2.attrs["w-class"] = _attrvalue2;
