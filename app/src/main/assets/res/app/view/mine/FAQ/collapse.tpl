      ...
      var CollapseItem = it.htmlStrList[index];_$temp = _node;{
        var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 2699674499;{
          ...
          var _$parent3 = _$temp;var _node3 = { "attrs": {}, "tagName": "div", "sid": 2 };_node3.children = [];_node3.attrSize = 2;_node3.attrHash = 1455118195;_node3.attrs["w-class"] = "pi-collapse-head";{
            ...
            var _$parent6 = _$temp;var _node5 = { "attrs": {}, "tagName": "img", "sid": 4 };_node5.children = [];_node5.attrSize = 2;_node5.attrHash = 3739709094;{
              var _attrvalue2 = "";_attrvalue2 += it1.isExpanded(index) ? '../../../res/image/btn_bottom_arrow.png' : '../../../res/image/btn_right_arrow.png';_attrvalue2 += "";_node5.attrs["src"] = _attrvalue2;
          ...
          var _$parent7 = _$temp;var _node6 = { "attrs": {}, "tagName": "div", "sid": 5 };_node6.children = [];_node6.attrSize = 2;_node6.attrHash = 3977751271;{
            var _attrvalue3 = "";_attrvalue3 += "pi-collapse-item-panel ";_attrvalue3 += it1.isExpanded(index) ? 'pi-collapse-item-panel-border' : '';_attrvalue3 += "";_node6.attrs["w-class"] = _attrvalue3;
          }_node6.attrHash = _hash.nextHash(_node6.attrHash, _calTextHash(_node6.attrs["w-class"]));_node6.attrs["class"] = "pi-collapse-item-panel";_$temp = _node6;{
