                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                _context.next = 5;
                                return conMgr_1.sendCode(this.state.phone, this.state.oldCode);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 6:
                                _context2.prev = 6;
                                _context2.next = 9;
                                return conMgr_1.regPhone(this.state.phone, this.state.code);
                            ...
                            case 12:
                                ...
                                if (_context2.t0.type === -300) {
                                    root_1.popNew('app-components-message-message', { itype: 'error', center: true, content: "\u9A8C\u8BC1\u7801\u65E0\u6548\uFF0C\u8BF7\u91CD\u65B0\u83B7\u53D6" });
                                } else if (_context2.t0.type === -301) {
                                    root_1.popNew('app-components-message-message', { itype: 'error', center: true, content: "\u9A8C\u8BC1\u7801\u65E0\u6548\uFF0C\u8BF7\u91CD\u65B0\u83B7\u53D6" });
                                } else {
                                    root_1.popNew('app-components-message-message', { itype: 'error', center: true, content: "\u9519\u8BEF" + _context2.t0.type });
                                }
