								...
								var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 124358627;_node.attrs["class"] = "ga-new-page";_node.attrs["w-class"] = "ga-new-page";_$temp = _node;{
												var _$parent2 = _$temp;var _node2 = { "attrs": {}, "tagName": "div", "sid": 1 };_node2.children = [];_node2.attrSize = 1;_node2.attrHash = 3010684512;_node2.attrs["w-class"] = "botBox";_$temp = _node2;{
																...
																var _$parent10 = _$temp;var _node9 = { "attrs": {}, "tagName": "div", "sid": 6 };_node9.children = [];_node9.attrSize = 1;_node9.attrHash = 3224068953;_node9.attrs["w-class"] = "details";_$temp = _node9;{
																				...
																				var _$parent14 = _$temp;var _node12 = { "attrs": {}, "tagName": "p", "sid": 8 };_node12.children = [];_node12.attrHash = 0;_$temp = _node12;{
																								var _$parent15 = _$temp;var _node13 = _installText("产品名称：", 2003985254);;
																								_$parent15.children.push(_node13);
																				}_$temp = _node12;{
																								var _$parent16 = _$temp;_addText(it.productName, _$parent16);
																				}_chFunc(_node12);_$parent14.children.push(_node12);
																}_$temp = _node9;{
																				var _$parent17 = _$temp;var _node14 = { "attrs": {}, "tagName": "p", "sid": 9 };_node14.children = [];_node14.attrHash = 0;_$temp = _node14;{
																								var _$parent18 = _$temp;var _node15 = _installText("购买份数：", 2135069541);;
																								_$parent18.children.push(_node15);
																				}_$temp = _node14;{
																								var _$parent19 = _$temp;_addText(it.amount, _$parent19);
																				}_$temp = _node14;{
																								var _$parent20 = _$temp;var _node16 = _installText("份", 4105707745);;
																								_$parent20.children.push(_node16);
																				}_chFunc(_node14);_$parent17.children.push(_node14);
																}_$temp = _node9;{
																				var _$parent21 = _$temp;var _node17 = { "attrs": {}, "tagName": "p", "sid": 10 };_node17.children = [];_node17.attrHash = 0;_$temp = _node17;{
																								var _$parent22 = _$temp;var _node18 = _installText("年化收益：", 637568466);;
																								_$parent22.children.push(_node18);
																				}_$temp = _node17;{
																								var _$parent23 = _$temp;_addText(it.expectedEarnings, _$parent23);
																				}_chFunc(_node17);_$parent21.children.push(_node17);
																}_$temp = _node9;{
																				var _$parent24 = _$temp;var _node19 = { "attrs": {}, "tagName": "p", "sid": 11 };_node19.children = [];_node19.attrHash = 0;_$temp = _node19;{
																								var _$parent25 = _$temp;var _node20 = _installText("锁定期：", 2508525672);;
																								_$parent25.children.push(_node20);
																				}_$temp = _node19;{
																								var _$parent26 = _$temp;_addText(it.lockday, _$parent26);
																				}_chFunc(_node19);_$parent24.children.push(_node19);
																}_chFunc(_node9);_$parent10.children.push(_node9);
												}_$temp = _node2;{
																var _$parent27 = _$temp;var _node21 = { "attrs": {}, "tagName": "div", "sid": 12 };_node21.children = [];_node21.childHash = 1405524631;_node21.attrSize = 1;_node21.attrHash = 2461161729;_node21.attrs["w-class"] = "btnBox";_$temp = _node21;{
																				var _$parent28 = _$temp;var _node22 = _installText("如果云账户余额不够，将自动从本地钱包中扣款", 4141238712);;
																				_$parent28.children.push(_node22);
																}_$temp = _node21;{
																				var _$parent29 = _$temp;var _node23 = { "attrs": {}, "tagName": "div", "sid": 13 };_node23.children = [];_node23.childHash = 1928398650;_node23.attrSize = 2;_node23.attrHash = 4078585008;_node23.attrs["w-class"] = "confirmBtn";_node23.attrs["on-tap"] = "purchaseClicked";_$temp = _node23;{
																								var _$parent30 = _$temp;var _node24 = _installText("立即购买", 2031045164);;
