...
var popNewPage = function popNewPage() {
    var hasReadedPrivacyAgreement = tools_1.getLocalStorage('hasReadedPrivacyAgreement');
...
var initEthTokenDecimals = function initEthTokenDecimals() {
    ...
    newTokenNames.forEach(function (tokenName) {
        ...
        api.ethCall(tokens_1.ERC20Tokens[tokenName], decimalsCode).then(function (r) {
            var ERC20TokenDecimals = tools_1.getLocalStorage('ERC20TokenDecimals') || {};
            // tslint:disable-next-line:radix
            ERC20TokenDecimals[tokenName] = Math.pow(10, parseInt(r));
            tools_1.setLocalStorage('ERC20TokenDecimals', ERC20TokenDecimals);
        });
    });
};
/**
...
var checkHasNewTokens = function checkHasNewTokens() {
    var localTokenNames = Object.keys(tools_1.getLocalStorage('ERC20TokenDecimals') || {});
...
var ifNeedUnlockScreen = function ifNeedUnlockScreen() {
    ...
    var openLockScreen = tools_1.getLocalStorage('openLockScreen') !== false;
