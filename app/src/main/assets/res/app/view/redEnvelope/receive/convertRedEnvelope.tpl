(function (_cfg, it, it1) {
	var _$temp = void 0,
		...
		var _$parent = _$temp;var _node = { "attrs": {}, "tagName": "div", "sid": 0 };_node.children = [];_node.attrSize = 2;_node.attrHash = 124358627;_node.attrs["class"] = "ga-new-page";_node.attrs["w-class"] = "ga-new-page";_$temp = _node;{
			...
			var _$parent12 = _$temp;var _node12 = { "attrs": {}, "tagName": "div", "sid": 7 };_node12.children = [];_node12.childHash = 787036364;_node12.attrSize = 1;_node12.attrHash = 406484528;_node12.attrs["w-class"] = "ga-tag";_$temp = _node12;{
				var _$parent13 = _$temp;var _node13 = _installText("未领取的红包，将于24小时候发起退款", 2194539403);;
