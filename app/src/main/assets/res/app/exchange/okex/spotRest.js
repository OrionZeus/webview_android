_$define("app/exchange/okex/spotRest", function (require, exports, module){
"use strict";
...
var BASE_URL = 'https://www.okcoin.com';
...
var getDepth = function getDepth(coin, currency) {
    return new Promise(function (resolve) {
        var url = BASE_URL + "/api/v1/depth.do?symbol=" + coin + "_" + currency;
