_$define("app/components/input/input_search", function (require, exports, module){
"use strict";
...
var Input = function (_widget_1$Widget) {
    ...
    _createClass(Input, [{
        ...
        value: function showClear() {
            ...
            return this.props && this.props.clearable && !this.props.disabled;
        }
        // 清空文本框
        ...
        value: function setTextareaHeight() {
            ...
            var result = calcTextareaHeight_1.calcTextareaHeight(childNode);
