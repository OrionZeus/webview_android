...
public class Test extends BaseJSModule {
    ...
    public void testCallback(int id, int cbID) {
        ...
        JSCallback.callJS(null, null, cbID, JSCallback.CALLBACK, "Android Test.testCallback 1", cbID);
        JSCallback.callJS(null, null, cbID, JSCallback.CALLBACK, "Android Test.testCallback 2", cbID);
        JSCallback.callJS(null, null, cbID, JSCallback.CALLBACK, "Android Test.testCallback 3", cbID);
    }
    ...
    public void testInstance(int cbID, int a, int b, float c, double d, String s) {
        ...
        JSCallback.callJS(null, null, cbID, JSCallback.SUCCESS, "Android Test.testInstance", a, b, c, d, s);
    }
    ...
    public static void testStatic(int cbID, int a, int b, float c, double d, String s) {
        ...
        JSCallback.callJS(null, null, cbID, JSCallback.SUCCESS, "Android Test.callStatic", a, b, c, d, s);
    }
}
