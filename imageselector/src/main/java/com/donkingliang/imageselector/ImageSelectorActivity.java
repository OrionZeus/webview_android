...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void initView() {
        this.rvImage = findViewById(R.id.rv_image);
        this.rvFolder = findViewById(R.id.rv_folder);
        this.tvConfirm = findViewById(R.id.tv_confirm);
        this.tvPreview = findViewById(R.id.tv_preview);
        this.btnConfirm = findViewById(R.id.btn_confirm);
        this.btnPreview = findViewById(R.id.btn_preview);
        this.tvFolderName = findViewById(R.id.tv_folder_name);
